...
// NOTE: Переменная содержащая все заклинания
final allSpells = AllSpellsModel(allSpells: getSpells());

// Реализован источник заклинаний передающий класс со всеми заклинаниями и пустыми массивами уровней заклинаний.
class SpellsDataSourseImpl implements SpellsDataSourse {
  /* 
  Изначально пустая модель с массивами,
  куда будут добавляться заклинания в "избранное"
  */
  AllSpellsModel cartModel = AllSpellsModel(allSpells: []);

  // NOTE: Возвращает модель со всеми заклинаниями
  @override
  AllSpellsModel getAllSpells() {
    return allSpells;
  }

  // NOTE: Возвращает модель с заклинаниями в "избранном"
  AllSpellsModel getCartSpells() => cartModel;

  // NOTE: Добавляем заклинание в "извранное"
  void addSpellToCart(SpellModel spell) => cartModel.allSpells.add(spell);

  // NOTE: 
  void removeSpellFromCart(SpellModel spell) => cartModel.allSpells.remove(spell);
  
}

// Возвращает массив ВСЕХ заклинаний
List<SpellModel> getSpells() {
  return [
    SpellModel(
      ...
      components: "В, С",
      duration: "Мгновенная",
      classes: const ["Волшебник", "Изобретатель", "Чародей"],
    ...
    SpellModel(
        ...
        classes: const ["Волшебник", "Друид", "Чародей"],
    ...
    SpellModel(
        ...
        classes: const ["Бард", "Волшебник", "Чародей"],
        source: "Player’s handbook",
        description:
    ...
    SpellModel(
        ...
        classes: const ["Друид", "Жрец", "Паладин"],
        source: "Player’s handbook",
        description:
    ...
    SpellModel(
        ...
        duration: "Мгновенная",
        classes: const ["Друид", "Жрец", "Изобретатель", "Паладин", "Следопыт"],
        source: "Player’s handbook",
        description:
    ...
    SpellModel(
        ...
        components: "В, С",
        duration: "Концентрация, вплоть до 10 минут",
        classes: const ["Волшебник", "Колдун", "Чародей"],
        source: "Xanathar’s Guide to Everything",
        description:
    ...
    SpellModel(
        ...
        duration: "8 часов",
        classes: const ["Бард", "Волшебник", "Колдун"],
        source: "Player’s handbook",
        description:
    ...
    SpellModel(
        ...
        duration: "10 дней",
        classes: const ["Бард", "Волшебник", "Друид"],
        source: "Player’s handbook",
        description:
    ...
    SpellModel(
        ...
        duration: "Концентрация, вплоть до 1 минуты",
        classes: const ["Волшебник", "Жрец", "Чародей", "Колдун"],
        source: "Player’s handbook",
        description:
    ...
    SpellModel(
        ...
        duration: "Пока не рассеется",
        classes: const ["Волшебник", "Колдун"],
        source: "Player’s handbook",
        description:
